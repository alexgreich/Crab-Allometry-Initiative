...
This analysis implies that we need to be more conservative. From this analysis, coxa width thresholds (threshold # or higher is a legal crab) of 31, 32, and 33 have rates of 0.039, 0.104, and 0.241 chance of being attached to a legal size crab, respectively. Coxa width thresholds of 29 and 30 look better, with respective rates of legality of 0.039 and 0.015. The binomial analysis indicates that we want a lower coxa threshold in order to avoid false positives (it was a legal crab and the trooper erroneously cites the fisherman based on the coxa width). Note that I did use the maximum coxa size for this analysis, so if there's a better angle to look at this data from please let me know.
