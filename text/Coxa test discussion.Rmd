...
```
Figure 3. Data and the binomial fit.

```{r fig4}
knitr::include_graphics("../figures/max coxa graph.png")
```
Figure 4. Max coxa width by carapace width. The red dashed line indicates 178mm in carapace length. The vertical purple lines mark 31 and 32mm maximum coxa widths. In this graph, false postives can be seen on the 31mm and 32mm coxa widths that fall above the red line.
